...
public class NewsBean implements Serializable {
     ...
     * topic爬虫的构造器
     */
    public NewsBean(int depth, String topic, String host, String title, String url, String content, String html, int urlLen, int anchorLen, String anchor, String parameters) {
        this.depth = depth;
        this.topic = topic;
        this.host = host;
        this.title = title;
